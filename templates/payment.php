...
<div class="chain-checkout-box" id="chain-checkout-box" data-status="<?php echo esc_attr( $status ); ?>">
	<div class="chain-checkout-box__header">
		<h2><?php echo esc_html( sprintf( __( 'Pay with %s', 'chain-checkout' ), $coin['name'] ) ); ?></h2>
	...
	<?php else : ?>
		...
		<div class="chain-checkout-box__row">
			<div class="chain-checkout-box__field">
				...
				<button type="button" class="chain-checkout-copy button" data-copy="#chain-checkout-amount"><?php esc_html_e( 'Copy', 'chain-checkout' ); ?></button>
			...
			<div class="chain-checkout-box__field">
				...
				<button type="button" class="chain-checkout-copy button" data-copy="#chain-checkout-address"><?php esc_html_e( 'Copy', 'chain-checkout' ); ?></button>
			</div>
			<div class="chain-checkout-box__field">
